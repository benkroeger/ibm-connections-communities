...
const parseMemberCount = node =>
  parseInt(node.firstChild.data, 10);
...
const parseEntryNode = xmlNode =>
  parseXMLNode(
    xmlNode,
    {
      ...
      membercount: { selector: 'snx:membercount', transform: parseMemberCount },
      communityType: 'string(snx:communityType)',
    },
    xpath
  );
